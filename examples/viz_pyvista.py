#!/usr/bin/env python3
"""Visualise geometry with pyvista (full VTK 3-D rendering).

Install the extra first::

    uv add ionforge --extra viz-pyvista

Usage::

    python examples/viz_pyvista.py
"""
...
if __name__ == "__main__":
    ...
    geo.visualize(backend="pyvista", color_by="voltage", title="Einzel Lens (pyvista)", opacity=0.9)
