#!/usr/bin/env python3
"""Visualise geometry with matplotlib (no extra dependencies required).

Usage::

    python examples/viz_matplotlib.py
"""
...
if __name__ == "__main__":
    ...
    geo.visualize(backend="matplotlib", color_by="voltage", title="Einzel Lens (matplotlib)")
